export default {
  ...
  'Friday': '周五',
  'Saturday': '周六',
  'sheikh Computer': 'sheikh 的电脑',
  'sheikh is using': 'sheikh 正在使用',
  'Jump to live': '跳到实时',
  'Failed to load file content': '加载文件内容失败',
  'Give sheikh a task to work on...': '给 sheikh 一个任务...',
  // Shell tools
  ...
  'Archive': '压缩包',
  // Login/Register Page
  'Login to sheikh': '登录 sheikh',
  'Register to sheikh': '注册 sheikh',
  'Full Name': '姓名',
  'Email': '邮箱',
  'Password': '密码',
  ...
  'Registration successful! Welcome to sheikh': '注册成功！欢迎使用 sheikh',
